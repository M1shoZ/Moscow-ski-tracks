  ...
  <div class="container">
      <div class="row">
          <div class="col-md-6 tc">
              <h1 class="display-4">
                <!-- добавить иконки -->
                  <span class=""></span> Moscow Ski Tracks</h1> 
              <p class="lead">Сервис для поиска лыжных трасс в Москве</p>
          </div>
          <div class="col-md-6 d-flex justify-content-center align-items-center">
              <img src="images\1693271243_pushinka-top-p-katanie-na-lizhakh-kartinki-dlya-detei-pin-59.jpg" class="img-fluid rounded" alt="Привлекательная картинка">
          </div>
      </div>
  </div>
</section>
            ...
            <div class="row">
                ...
                <div class="col-lg-6">
                    ...
                    <ul class="support-list">
                        ...
                        <li><i class="fas fa-globe"></i> Источник данных: <a href="https://data.mos.ru/opendata/1233?pageSize=10&pageIndex=1&isDynamic=false" target="_blank">data.mos.ru</a></li>
                    </ul>
                </div>
            </div>
        </div>
